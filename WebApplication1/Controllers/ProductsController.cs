...
namespace WebApplication1.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,product_name,cat_id,brand_id,qty,price")] product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,product_name,cat_id,brand_id,qty,price")] product product)
        {
            if (ModelState.IsValid)
            {
